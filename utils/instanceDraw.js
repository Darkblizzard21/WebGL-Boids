...
const ID_VA = (
  ...
  const colorBuffer = webGL.makeBuffer(
    gl,
  ...
  const makeInstancedVA = (posBuffer, velBuffer) => {
    ...
    gl.vertexAttribPointer(
      drawInstancedProgLocs.a_position,
      2,
      gl.FLOAT,
      false,
      20,
    ...
    gl.vertexAttribDivisor(
      drawInstancedProgLocs.a_color,
      colors.length > 3 ? numParticles - 1 : numParticles
    );
    gl.enableVertexAttribArray(drawInstancedProgLocs.a_color);

    gl.bindBuffer(gl.ARRAY_BUFFER, posBuffer);
    gl.vertexAttribPointer(
      drawInstancedProgLocs.i_offset,
      2,
      gl.FLOAT,
      false,
      0,
    ...
    gl.vertexAttribPointer(
      drawInstancedProgLocs.i_velocity,
      2,
      gl.FLOAT,
      false,
      0,
...
export {ID_ProgramAndLocs, ID_VA, ID_Draw};
